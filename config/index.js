export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx20d9a22636b28c7d",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "229ab5d1c57ba7ac658691a7de1206d0",
  ...
  USERS: [
    ...
    {
      name: "傻逼",
      id: "o6fi75-5RsXLr1QKz5jpp1nfHwoY",
      useTemplateId: "mJglIMYh39ipHTOS8_ssI7RQ8eor-JusiHJwwOdEhyo",
      province: "",
      city: "",
      horoscopeDate: '',
      horoscopeDateType: '',
